...
import { View, Button, Text,ImageBackground, StyleSheet,TouchableOpacity, Linking, Image,ActivityIndicator} from 'react-native';
...
const FaceDetectionScreen = ({navigation}) => {
  ...
  const handlePredictButtonPress = async () => {
    ...
    const apiUrl = 'http://'+api+':8000/face_recognition'
  ...
  return (
    ...
    >
      ...
      {!selectedVideo && !loading && !videoLink && <Image
        source={require('../assets/facerecog.jpg')} // Replace with your image source
        style={styles.image}
      />}
